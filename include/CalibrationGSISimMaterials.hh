/// CalibrationGSISimMaterials.hh
//// Auteur: Arnaud HUBER for ENL group <huber@cenbg.in2p3.fr>
/// Copyright: 2023 (C) LP2IB-ENL

// This class is used to create a plastic scintillator.

#ifndef CalibrationGSISimMaterials_h
#define CalibrationGSISimMaterials_h
...
public:
  ...
  CalibrationGSISimMaterials(G4String prop_buildfile);
  ~CalibrationGSISimMaterials();
  void Construct();
