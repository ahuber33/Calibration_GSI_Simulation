...
CalibrationGSISimPhysics::CalibrationGSISimPhysics():  G4VModularPhysicsList(), fThermal(true)
{
  // Here used the default cut value you have typed in

  //defaultCutValue = 0.001*mm; //0.001
  defaultCutValue = 1*nm; //0.001
  //was 0.5*mm
...
CalibrationGSISimPhysics::~CalibrationGSISimPhysics(){
  delete raddecayList;
  delete emPhysicsList;
}

void CalibrationGSISimPhysics::ConstructParticle()
{
...
void CalibrationGSISimPhysics::ConstructProcess()
{
...
void CalibrationGSISimPhysics::ConstructNeutron()
{
...
void CalibrationGSISimPhysics::SetCuts()
{
