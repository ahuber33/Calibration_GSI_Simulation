...
const G4String CalibrationGSISimMaterials::path = "../simulation_input_files/";
...
CalibrationGSISimMaterials::CalibrationGSISimMaterials(G4String prop_buildfile):bs_glass(0),
polysty(0),
Ti02(0),
coating(0),
scintillator(0),
...
CalibrationGSISimMaterials::~CalibrationGSISimMaterials()
{
...
void CalibrationGSISimMaterials::Construct()
{
	...
	elementBa = new G4Element("Barium","Ba",56., 138.9055*g/mole);
	...
	Polyester = new G4Material("Polyester", 1.66*g/cm3, 3);
	Polyester->AddElement(elementC, 0.625);
	Polyester->AddElement(elementH, 0.042);
	Polyester->AddElement(elementO, 0.333);
	...
	Sensitive->AddElement(elementN, 0.018);
	Sensitive->AddElement(elementBa, 0.463);
	Sensitive->AddElement(elementF, 0.064);
	Sensitive->AddElement(elementBr, 0.27);

	//#######################################################################################################################################
	//#######################################################################################################################################

	Base = new G4Material("Base", 2.77*g/cm3, 7);
	Base->AddElement(elementC, 0.121);
	Base->AddElement(elementH, 0.015);
	Base->AddElement(elementO, 0.354);
	Base->AddElement(elementN, 0.018);
	Base->AddElement(elementFe, 0.308);
	Base->AddElement(elementMn, 0.119);
	Base->AddElement(elementZn, 0.065);
...
G4Material* CalibrationGSISimMaterials::GetMaterial(G4String material)
{
